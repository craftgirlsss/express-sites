        ...
        <div className='bg-white p-4 rounded w-25'>
            ...
            <form action='' onSubmit={handleSubmit}>
                <div className='mb-3'>
                    ...
                    <input type='email' placeholder='Enter email address' className='form-control rounded' onChange={handleInput} name='email'/>
                    {errors.email && <span className='text-danger'> {errors.email} </span>}
                </div>
                <div className='mb-3'>
                    <label htmlFor='password'><strong>Kata Sandi</strong></label>
                    <input type='password' placeholder='Enter your password' className='form-control rounded' onChange={handleInput} name='password'/>
