        ...
        <div className='bg-white p-4 rounded w-25'>
            ...
            <form action='' onSubmit={handleSubmit}>
                <div className='mb-3'>
                    ...
                    <input type='name' placeholder='Masukkan nama anda' className='form-control rounded' onChange={handleInput} name='name'/>
                    {/* {errors.name && <span className='text-danger'> {errors.name} </span>} */}
                </div>
                <div className='mb-3'>
                    <label htmlFor='email'><strong>Email</strong></label>
                    <input type='email' placeholder='Masukkan email anda' className='form-control rounded' onChange={handleInput} name='email'/>
                    {errors.email && <span className='text-danger'> {errors.email} </span>}
                </div>
                <div className='mb-3'>
                    <label htmlFor='password'><strong>Kata Sandi</strong></label>
                    <input type='password' placeholder='Buat kata sandi' className='form-control rounded' onChange={handleInput} name='password'/>
